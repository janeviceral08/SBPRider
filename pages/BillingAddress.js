      ...
      <View >   
        <View style={styles.invoice}>
            ...
            <FlatList
              ...
              <Col>
    <Text style={{textAlign: 'center',fontSize: 13,  color:'black', fontStyle:'italic'}}>{item.datas.Sendto_Name}</Text>
              </Col>
            </Grid>
              <Grid style={{padding: 8}}>
              <Col>
                <Text style={{fontSize: 13, fontWeight: 'bold', color:'black'}}>Address:</Text>
              </Col>
              <Col>
    <Text style={{textAlign: 'center',fontSize: 13,  color:'black', fontStyle:'italic'}}>{item.datas.Address}</Text>
              </Col>
            </Grid>
            <Grid style={{padding: 8}}>
              <Col>
                <Text style={{fontSize: 13, fontWeight: 'bold', color:'black'}}>Landmark:</Text>
              </Col>
              <Col>
    <Text style={{textAlign: 'center',fontSize: 13,  color:'black', fontStyle:'italic'}}>{item.datas.Sendto_Landmark}</Text>
              </Col>
            </Grid>
            <Grid  style={{padding: 8}}>
            <Col>
              ...
              <Col>
    <Text style={{textAlign: 'center', fontSize: 13,  color:'black', fontStyle:'italic'}}>{item.datas.Sendto_Contact}</Text>
              </Col>
            </Grid>
            ...
            <TouchableOpacity 
            style = {styles.button}
            onPress={() => Communications.phonecall(item.datas.Sendto_Contact, true)}>
